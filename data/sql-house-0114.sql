...
insert  into `t_district`(`ID`,`NAME`) values (1,'南山区'),(2,'福田区'),(3,'罗湖区'),(6,'龙岗区'),(7,'盐田区');
...
insert  into `t_picture`(`ID`,`HOUSEID`,`TITLE`,`URL`) values (1,3,'pic','/upload\\dce91bf4-5a1f-40e1-8e18-ca3d8bb20a18.png'),(2,6,'pic','/resources/upload/a.png'),(3,9,'pic','/resources/upload/a.png'),(4,12,'pic','/resources/upload/a.png'),(5,13,'pic','/resources/upload/a.png');

/*Table structure for table `t_street` */
...
/*Data for the table `t_street` */

insert  into `t_street`(`ID`,`DISTRICTID`,`NAME`) values (1,1,'南新路'),(2,1,'上步路'),(3,1,'南头'),(4,1,'南山大道'),(5,1,'南头古城'),(11,2,'华强北'),(12,2,'车公庙'),(13,1,'深南大道'),(14,2,'华强南'),(21,3,'春风路'),(22,3,'水贝'),(23,6,'民治'),(24,6,'布吉'),(25,6,'龙岗'),(31,7,'沙头角东'),(32,7,'小梅沙东'),(33,7,'小梅沙'),(34,7,'沙头角');
...
insert  into `t_type`(`ID`,`NAME`) values (1,'一房一厅'),(2,'两房一厅'),(3,'三房一厅'),(4,'三房两厅');
...
insert  into `t_user`(`ID`,`USERNAME`,`PASSWORD`,`TELEPHONE`,`REALNAME`,`ISADMIN`) values (1,'admin','admin','15800001234','张三丰','y'),(2,'abc','abc','15817412345','王五','n'),(3,'abcd','abcd','13512341234','赵半山','n'),(4,'test','test','13800138000','吴六奇','y');
